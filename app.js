  ...
  const SYMPTOMS = {
    ...
    ordinary: {
      ...
      messages: [
        ...
        '무탈하게 흘러가는 것도 행운이에요',
        '오늘 하루, 있는 그대로 좋아요',
        '아무 일 없는 게 제일 좋은 날이에요',
        '평범함은 지켜낸 결과예요',
        '오늘 같은 날이 쌓여서 괜찮아지는 거예요',
        '특별하지 않아도 충분해요',
        '무난하게 지나간 하루도 성공이에요',
        '이런 날을 알아보는 게 어른이에요',
      ],
    ...
    // 기대한 일이 어긋난 뒤에 남는 감정. 분노도 서운함도 아닌 "힘이 쭉 빠진" 자리다.
    // 20개 중에 이걸 받아주는 감정이 없어서, 응원팀이 지거나 결과 발표가 엎어진 날
    // 사용자가 고를 칸이 없었다.
    deflated: {
      emoji: '😮‍💨', label: '허탈함', mg: '9.5mg', color: '#8c9bb0',
      caption: '힘이 쭉 빠진 마음, 천천히 채워드릴게요',
      messages: [
        '힘이 빠지는 날도 있어요. 오늘이 그런 날이에요',
        '기대한 만큼 허전한 거예요. 이상한 게 아니에요',
        '지금은 채우려 하지 말고 그냥 비워두세요',
        '애쓴 게 없어진 건 아니에요',
        '허탈한 건 그만큼 진심이었다는 뜻이에요',
        '괜찮은 척은 안 해도 돼요',
        '다음이 있다는 것만 기억하면 돼요',
        '이 빈 자리, 생각보다 금방 메워져요',
        '오늘은 아무것도 안 해도 되는 날로 칩시다',
        '좋아하는 거 하나만 챙겨 드세요',
      ],
    },
    // 다이어트하는 사람의 감정 두 가지.
    //
    // 주의해서 쓴 부분: 이 앱은 절제를 시키지 않는다. "참으세요"라고 말하는 순간
    // 절제를 성취로 만드는 구조가 되고, 그건 섭식장애가 있는 사람에게 직접적인
    // 악화 요인이다. 마음약국·연속출석 같은 수집 구조를 이미 갖고 있어서 더 위험하다.
    // 그래서 메시지는 전부 "먹는 것과 내 가치를 떼어놓는" 쪽으로만 쓴다.
    // 몸(체중·칼로리)은 이 앱이 다루지 않는다.
    craving: {
      emoji: '🍕', label: '식욕 폭발', mg: '4.5mg', color: '#f4a261',
      caption: '당기는 마음, 그대로 인정해드릴게요',
      messages: [
        '먹고 싶은 건 잘못이 아니에요',
        '몸이 보내는 신호일 수도 있어요',
        '오늘 뭘 먹든 당신 가치는 그대로예요',
        '배고픔이 아니라 지침일 때도 있어요',
        '먹고 나서 자책할 일은 안 만들어도 돼요',
        '지금 제일 당기는 걸 천천히 드세요',
        '참느라 쓴 힘도 만만치 않았어요',
        '한 끼가 전체를 망치지 않아요',
        '먹는 속도만 조금 늦춰볼까요',
        '내일의 나는 오늘의 나를 이해할 거예요',
      ],
    },
    selfblame: {
      emoji: '🫠', label: '자책', mg: '8.5mg', color: '#9d8189',
      caption: '스스로를 너무 모질게 대하는 마음, 말려드릴게요',
      messages: [
        '그건 당신 잘못만은 아니에요',
        '자책은 반성이랑 달라요. 오래 하면 해로워요',
        '남한테는 그렇게 말하지 않잖아요',
        '이미 충분히 미안해하고 있어요',
        '실수는 정보지 낙인이 아니에요',
        '오늘치 자책은 여기까지 해요',
        '다음에 잘하면 되는 일이에요',
        '당신을 제일 모질게 대하는 사람이 당신이에요',
        '그때는 그게 최선이었어요',
        '스스로한테도 한 번은 봐줘도 돼요',
      ],
    },
